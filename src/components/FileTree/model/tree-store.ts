...
export default class TreeStore {
  ...
  remove(data: TreeNodeData | Node): void {
    ...
    if (node && node.parent) {
      ...
      if (node === this.currentRightClickNode) {
        this.currentRightClickNode = null;
      }
  ...
  getPreCurrentNode(): Node {
    return this.preCurrentNode;
  }

  setPreCurrentNode(preCurrentNode: Node): void {
    this.preCurrentNode = preCurrentNode;
  ...
  getCurrentRightClickNode(): Node {
    return this.currentRightClickNode;
  }

  setCurrentRightClickNode(_currentRightClickNode: Node): void {
    const prevCurrentNode = this.currentRightClickNode;
    if (prevCurrentNode) {
      prevCurrentNode.isCurrent = false;
    }
    this.currentRightClickNode = _currentRightClickNode;
    if (_currentRightClickNode) {
      this.currentRightClickNode.isCurrent = true;
    }
